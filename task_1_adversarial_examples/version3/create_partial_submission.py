#!/usr/bin/env python3
"""
Utility to create a partial submission file from Lock & Ram checkpoint.
...
def main():
    parser = argparse.ArgumentParser(
        description='Create partial submission from Lock & Ram checkpoint',
    ...
    parser.add_argument('--checkpoint', type=str, default='./logs/lock_and_ram_checkpoint.json',
                       help='Path to checkpoint file')
    parser.add_argument('--dataset', type=str, default='../natural_images.pt',
                       help='Path to natural_images.pt')
    parser.add_argument('--output-dir', type=str, default='./output',
                       help='Output directory')
    parser.add_argument('--output-name', type=str, default='submission_ram_partial.npz',
    ...
    print("=" * 70)
    print("Create Partial Submission from Checkpoint")
    print("=" * 70)
    ...
    # Identify SUCCESS/FAILED from previous submission
    ...
    if not checkpoint_path.exists():
        ...
        print(f"   Run lock_and_ram.py first to generate checkpoint.")
        return
    ...
    print(f"2. Continue RAM attack: Run lock_and_ram.py (will resume from checkpoint)")
