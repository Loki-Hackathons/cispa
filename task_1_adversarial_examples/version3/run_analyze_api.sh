#!/bin/bash
# Wrapper script to analyze submission with API
# Usage: ./run_analyze_api.sh <submission_file.npz>
...
echo "Analyzing: $SUBMISSION_FILE"
python3 analyze.py "$SUBMISSION_FILE" --mode api
